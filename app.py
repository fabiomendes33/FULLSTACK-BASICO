...
@app.post('/Cadastrar Novo Produto', tags=[produto_tag],
...
@app.get('/Busca Todos produtos Cadastrados', tags=[produto_tag],
...
@app.get('/Busca por ID do Produto', tags=[produto_tag],
...
@app.delete('/Exclui produto a Partir Nome', tags=[produto_tag],
